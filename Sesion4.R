...
enlaces <- xpathSApply(parsedHtml, "//a",  xmlGetAttr, "title") 
enlaces
...
url <- "https://campus.universidadviu.com/"
url1 <- "/video1.mp4"
...
#URL sin protocolos
b <- length(grep("campus.universidadviu.com", url)) > 0 | a     # Absoluta
b
b1 <- length(grep("campus.universidadviu.com/", url1)) > 0 | a1   # Relativo
b1
...
handler <- handle("https://campus.universidadviu.com/");
handler
...
html <- GET("https://campus.universidadviu.com/")  
html
